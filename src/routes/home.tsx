      ...
      <Container>
        <div className="my-8">
          ...
          <p className="mt-4 text-muted-foreground text-base"> 
           ...
           Discover a smarter way to prepare, practice, and stand out from the competition. With intelligent feedback tailored to your unique strengths and weaknesses, 
           you’ll gain the confidence to tackle even the toughest questions.
          </p>
        </div>
